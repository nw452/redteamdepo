...
unsup_file_names, unsup_corpus, unsup_aggregate_corpus = \
    corpus_creator(input_directory_path = 'input_raw_data/twitter_chipotle_17/',\
        output_directory_path = 'output_parsed_data/chipotle_17_v4/')
...
while (length_test < 25):
    ...
    nkeys = nkeys + 1
print(nkeys)
# nkeys reached to 2237 to get 25 positive words; 
...
while (length_test < 25):
    ...
    nkeys = nkeys + 1
print(nkeys)
# nkeys is 1408 to get 25 negative words
...
plt.savefig('fig_sentiment_text_measures_scatter_plot_chipotle17.pdf', 
...
plt.show()  
plt.savefig('fig_line_plot_chipotle17.pdf', 
    bbox_inches = 'tight', dpi=None, facecolor='none', edgecolor='blue', 
    orientation='portrait', papertype=None, format=None, 
    transparent=True, pad_inches=0.25, frameon=None) 
